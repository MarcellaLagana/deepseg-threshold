...
#
# Usage:
#   ./deepseg_threshold.sh <SUBJECT> <FILEPARAM>
#
# To run it across multiple subjects, you can use SCT's sct_run_batch:
#   sct_run_batch parameters.sh deepseg_threshold.sh
#
# For more information about parameters.sh, see:
# https://github.com/neuropoly/spinalcordtoolbox/blob/master/shell/parameters_example.sh
#
#
